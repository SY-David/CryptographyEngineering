...
void fe25519_square(fe25519 *r, const fe25519 *x)
{
  ...
  int64_t h1 = f0_2 * f1 + f2 * f9_38 + f3_2 * f8_38 + f4 * f7_38 + f5_2 * f6_38;
  int64_t h2 = f0_2 * f2 + f1 * f1_2 + f3_2 * f9_38 + f4_2 * f8_38 + f5_2 * f7_38 + f6 * f6_19;
  int64_t h3 = f0_2 * f3 + f1_2 * f2 + f4 * f9_38 + f5_2 * f8_38 + f6 * f7_38;
  int64_t h4 = f0_2 * f4 + f1_2 * f3_2 + f2 * f2 + f5_2 * f9_38 + f6_2 * f8_38 + f7 * f7_38;
  int64_t h5 = f0_2 * f5 + f1_2 * f4 + f2_2 * f3 + f6 * f9_38 + f7_2 * f8_38;
